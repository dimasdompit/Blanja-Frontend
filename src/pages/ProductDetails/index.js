...
import { addToCart } from '../../config/Redux/actions/cart'
...
class ProductDetails extends Component {
    ...
    buyNow = () => {
        ...
        this.props.addToCart(this.state.qty, this.state.product)
        ...
        return (
            <div className='product__details__container'>
                <Container>
                    ...
                    {category !== undefined && <Breadcrumbs category={category.category} />}
                    ...
                    <div className="top__content">
                        <Row>
                            ...
                            <Col md={6}>
                                ...
                                <Brand title={product_name} store={store} price={price} color={color !== undefined && color.color} />
                                <div className="right__content__bottom">
                                    <Row className='size__content'>
                                        ...
                                        <Col>
                                            ...
                                            <Gap height={5} />
                                            <Headline type='h3' title={size !== undefined && size.size} />
                                        </Col>
                                        {/* ======================== PRODUCT QUANTITY ======================== */}
                                    ...
                                    <div className='btn__content'>
                                        ...
                                        <Gap width={20} />
                                        <Button variant='outline-round' title='Add bag' padding={15} onClick={() => this.props.addToCart(this.state.qty, this.state.product)} />
                                    </div>
                                    <Gap height={30} />
                    ...
                    <div className="center__content">
                        ...
                        <ProductInformation condition={condition_name !== undefined && condition_name.condition_name} description={description} />
                    </div>
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        addToCart: (qty, product) => dispatch(addToCart(qty, product))
    }
}
